import { B as Build, y as getElementDir, l as h } from './messageBundle-251c02f0.js';
import { d as debounce } from './debounce-b75c925d.js';
...
const FloatingArrow = ({ floatingLayout, key, ref, }) => {
  ...
  const dValue = "M0,0" +
    ...
    " Z";
  return (h("svg", { "aria-hidden": "true", class: CSS$1.arrow, height: width, key: key, ref: ref, viewBox: `0 0 ${width} ${width + (!isVertical ? strokeWidth : 0)}`, width: width + (isVertical ? strokeWidth : 0) },
    strokeWidth > 0 && (h("path", { class: CSS$1.arrowStroke, d: dValue, fill: "none", "stroke-width": strokeWidth + 1 })),
    h("path", { d: dValue, stroke: "none" })));
};

export { FloatingArrow as F, disconnectFloatingUI as a, FloatingCSS as b, connectFloatingUI as c, defaultOffsetDistance as d, filterComputedPlacements as f, reposition as r };

//# sourceMappingURL=FloatingArrow-52a7c4b7.js.map