...
import { a as Ss, I as Ia, j as jp, v as vp, m as ml, S as Slot, p as pp, C as Ca } from './interfaces-f9f0dded.js';
...
const ArcGISChartsBarLineChart = class {
  ...
  rotationChange(newRotation) {
    this.config = Ss(newRotation, this.config);
  }
  /**
  ...
  async componentDidLoad() {
    ...
    // Remove selection events for chart from table
    if (((_a = this.layer) === null || _a === void 0 ? void 0 : _a.isTable) === true && this.chart !== undefined) {
      this.chart.setActionMode(jp.None);
    }
  }
  /**
   * @category Lifecycle
  ...
  async componentDidUpdate() {
    ...
    await vp([WebChartTypes.BarSeries, WebChartTypes.LineSeries], this.config);
    ...
    // Remove selection events for chart from table
    if (((_b = this.layer) === null || _b === void 0 ? void 0 : _b.isTable) === true && this.chart !== undefined) {
      this.chart.setActionMode(jp.None);
    }
  }
  /**
  ...
  render() {
    ...
    const chartStyles = this.showNotifyPanel === true && ((_a = this.notifyOptions) === null || _a === void 0 ? void 0 : _a.kind) === "danger"
      ? "hide"
      : `${WebChartTypes.ComboLineAndBarSeries} show`;
...
ArcGISChartsBarLineChart.style = arcgisChartsBarLineChartCss;

export { ArcGISChartsBarLineChart as arcgis_charts_bar_line_chart };

//# sourceMappingURL=arcgis-charts-bar-line-chart.entry.js.map