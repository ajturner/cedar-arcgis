import { j as forceUpdate, p as proxyCustomElement, H, J as createEvent, T as setRequestedIcon, l as h, U as getSlotted } from './messageBundle-251c02f0.js';
...
import { c as connectLocalized, a as connectMessages, d as disconnectLocalized, b as disconnectMessages, s as setUpMessages, u as updateMessages } from './t9n-5ff39294.js';
...
const Notice = /*@__PURE__*/ proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return (h("div", { class: CSS.container,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setTransitionEl }, this.requestedIcon ? (h("div", { class: CSS.icon }, h("calcite-icon", { flipRtl: this.iconFlipRtl, icon: this.requestedIcon, scale: this.scale === "l" ? "m" : "s" }))) : null, h("div", { class: CSS.content }, h("slot", { name: SLOTS.title }), h("slot", { name: SLOTS.message }), h("slot", { name: SLOTS.link })), hasActionEnd ? (h("div", { class: CSS.actionsEnd }, h("slot", { name: SLOTS.actionsEnd }))) : null, this.closable ? closeButton : null));
  }
  //--------------------------------------------------------------------------
  //
  //  Public Methods
...
//# sourceMappingURL=calcite-notice-319ec00c.js.map