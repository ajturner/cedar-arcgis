import { p as proxyCustomElement, H, O as slotChangeHasAssignedElement, l as h, q as Host, u as closestElementCrossShadowBoundary, M as queryElementRoots, V as isBefore, y as getElementDir, X as CSS_UTILITY, J as createEvent, U as getSlotted, I as isPrimaryPointerButton, T as setRequestedIcon, N as Fragment, s as toAriaBoolean } from './messageBundle-251c02f0.js';
import { c as connectInteractive, d as disconnectInteractive, u as updateHostInteraction, a as defineCustomElement$8 } from './loader-fc4f5566.js';
import { c as createObserver } from './observers-cbe7e92f.js';
import { u as updateListItemChildren, g as getListItemChildren, M as MAX_COLUMNS } from './utils3-bb03c824.js';
import { s as setUpLoadableComponent, a as setComponentLoaded, c as componentFocusable } from './loadable-bd375668.js';
import { S as Symbol$1, i as isSymbol, a as isObject, b as baseGetTag, c as isObjectLike, r as root, f as freeGlobal, d as debounce } from './debounce-b75c925d.js';
import { n as numberStringFormatter, e as isValidNumber, p as parseNumberString, f as numberKeys, g as sanitizeNumberString, h as addLocalizedTrailingDecimalZeros, u as updateMessages, c as connectLocalized, a as connectMessages, d as disconnectLocalized, b as disconnectMessages, s as setUpMessages, B as BigDecimal } from './t9n-5ff39294.js';
import { d as defineCustomElement$6 } from './icon-927a6d1d.js';
import { d as defineCustomElement$7 } from './scrim-6be7690b.js';
...
const Stack = /*@__PURE__*/ proxyCustomElement(class extends H {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
  ...
  renderActionsStart() {
    ...
    return (h("div", { class: CSS$3.actionsStart, hidden: !hasActionsStart, key: "actions-start-container" }, h("slot", { name: SLOTS$2.actionsStart, onSlotchange: this.handleActionsStartSlotChange })));
  }
  renderActionsEnd() {
    const { hasActionsEnd } = this;
    return (h("div", { class: CSS$3.actionsEnd, hidden: !hasActionsEnd, key: "actions-end-container" }, h("slot", { name: SLOTS$2.actionsEnd, onSlotchange: this.handleActionsEndSlotChange })));
  }
  renderContentStart() {
    const { hasContentStart } = this;
    return (h("div", { class: CSS$3.contentStart, hidden: !hasContentStart }, h("slot", { name: SLOTS$2.contentStart, onSlotchange: this.handleContentStartSlotChange })));
  }
  renderDefaultContent() {
    return (h("div", { class: CSS$3.content }, h("slot", null)));
  }
  renderContentEnd() {
    const { hasContentEnd } = this;
    return (h("div", { class: CSS$3.contentEnd, hidden: !hasContentEnd }, h("slot", { name: SLOTS$2.contentEnd, onSlotchange: this.handleContentEndSlotChange })));
  }
  render() {
    return (h(Host, null, h("div", { class: CSS$3.container }, this.renderActionsStart(), this.renderContentStart(), this.renderDefaultContent(), this.renderContentEnd(), this.renderActionsEnd())));
  }
...
const Input = /*@__PURE__*/ proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return (h(Host, { onClick: this.clickHandler, onKeyDown: this.keyDownHandler }, h("div", { class: { [CSS$2.inputWrapper]: true, [CSS_UTILITY.rtl]: dir === "rtl" } }, this.type === "number" && this.numberButtonType === "horizontal" && !this.readOnly
      ...
      : null, this.prefixText ? prefixText : null, h("div", { class: CSS$2.wrapper }, localeNumberInput, childEl, this.isClearable ? inputClearButton : null, this.requestedIcon ? iconEl : null, this.loading ? loader : null), h("div", { class: CSS$2.actionWrapper }, h("slot", { name: SLOTS$1.action })), this.type === "number" && this.numberButtonType === "vertical" && !this.readOnly
...
const List = /*@__PURE__*/ proxyCustomElement(class extends H {
  ...
  render() {
    ...
    return (h("div", { class: CSS.container }, this.dragEnabled ? (h("span", { "aria-live": "assertive", class: CSS.assistiveText }, this.assistiveText)) : null, loading ? h("calcite-scrim", { class: CSS.scrim, loading: loading }) : null, h("table", { "aria-busy": toAriaBoolean(loading), "aria-label": label || "", class: CSS.table, onKeyDown: this.handleListKeydown, role: "treegrid" }, filterEnabled || hasFilterActionsStart || hasFilterActionsEnd ? (h("thead", null, h("tr", { class: { [CSS.sticky]: true } }, h("th", { colSpan: MAX_COLUMNS }, h("calcite-stack", { class: CSS.stack }, h("slot", { name: SLOTS.filterActionsStart, onSlotchange: this.handleFilterActionsStartSlotChange, slot: SLOTS$2.actionsStart }), h("calcite-filter", { "aria-label": filterPlaceholder, disabled: loading || disabled, items: dataForFilter, onCalciteFilterChange: this.handleFilterChange, placeholder: filterPlaceholder, value: filterText,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setFilterEl }), h("slot", { name: SLOTS.filterActionsEnd, onSlotchange: this.handleFilterActionsEndSlotChange, slot: SLOTS$2.actionsEnd })))))) : null, h("tbody", { class: CSS.tableContainer }, h("slot", { onSlotchange: this.handleDefaultSlotChange })))));
  }
  // --------------------------------------------------------------------------
  //
  //  Private Methods
...
//# sourceMappingURL=calcite-list-3e58cf53.js.map