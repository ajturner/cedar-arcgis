...
const ArcGISChartsScatterPlot = class {
  ...
  async componentDidUpdate() {
    ...
    await vp([WebChartTypes.ScatterSeries], this.config);
...
ArcGISChartsScatterPlot.style = arcgisChartsScatterPlotCss;

export { ArcGISChartsScatterPlot as arcgis_charts_scatter_plot };

//# sourceMappingURL=arcgis-charts-scatter-plot.entry.js.map