...
return mix(color, vec4(HIGHLIGHT_COLOR.rgb, color.a), highlightFactor * HIGHLIGHT_COLOR.a);
      ...
      `:Tt`#define highlightSlice(_color_, _pos_) (_color_)`;t.hasSliceInVertexProgram&&e.vertex.code.add(i),e.fragment.code.add(i),e.fragment.code.add(r)}function Un(e,t,o){return e.instancedDoublePrecision?g(Xn,o.camera.viewInverseTransposeMatrix[3],o.camera.viewInverseTransposeMatrix[7],o.camera.viewInverseTransposeMatrix[11]):t.slicePlaneLocalOrigin}function jn(e,t){return null!=e?f(Kn,t.origin,e):t.origin}function Wn(e,t,o){return e.hasSliceTranslatedView?null!=t?Q(Yn,o.camera.viewMatrix,t):o.camera.viewMatrix:null}function kn(e,t,o){if(null==o.slicePlane)return K;const i=Un(e,t,o),n=jn(i,o.slicePlane),r=Wn(e,i,o);return null!=r?C(Kn,n,r):n}function qn(e,t,o,i){if(null==i||null==o.slicePlane)return K;const n=Un(e,t,o),r=jn(n,o.slicePlane),s=Wn(e,n,o);return null!=s?(x(Qn,i,r),C(Kn,r,s),C(Qn,Qn,s),f(Qn,Qn,Kn)):i}const Xn=c(),Kn=c(),Qn=c(),Yn=be();function Zn(e){Vn(e),e.vertex.code.add(Tt`vec4 transformPositionWithDepth(mat4 proj, mat4 view, vec3 pos, vec2 nearFar, out float depth) {
...
return proj * (view * vec4(pos, 1.0));
    ...
    `)}Y([vr()],fr.prototype,"instancedDoublePrecision",void 0);const pr=c();function gr(e){e.vertex.code.add(Tt`
...
}`)}function Tr(e){e.uniforms.add(new Cr("screenSizePerspectiveAlignment",(e=>Ar(e.screenSizePerspectiveAlignment||e.screenSizePerspective))))}function Ar(e){return Z(Sr,e.parameters.divisor,e.parameters.offset,e.parameters.minPixelSize,e.paddingPixelsOverride)}const Sr=J();function _r(e,t){const o=e.vertex;t.hasVerticalOffset?(Lr(o),t.hasScreenSizePerspective&&(e.include(yr),Tr(o),ar(e.vertex,t)),o.code.add(Tt`
...
}`)}class Fr extends hi{constructor(e,t,o){super(e,"vec4",ui.Pass,((o,i,n)=>o.setUniform4fv(e,t(i,n))),o)}}class Dr extends hi{constructor(e,t,o){super(e,"float",ui.Pass,((o,i,n)=>o.setUniform1fv(e,t(i,n))),o)}}let zr=class extends ie{constructor(){super(...arguments),this.SCENEVIEW_HITTEST_RETURN_INTERSECTOR=!1,this.DECONFLICTOR_SHOW_VISIBLE=!1,this.DECONFLICTOR_SHOW_INVISIBLE=!1,this.DECONFLICTOR_SHOW_GRID=!1,this.LABELS_SHOW_BORDER=!1,this.TEXT_SHOW_BASELINE=!1,this.TEXT_SHOW_BORDER=!1,this.OVERLAY_DRAW_DEBUG_TEXTURE=!1,this.OVERLAY_SHOW_CENTER=!1,this.SHOW_POI=!1,this.TESTS_DISABLE_OPTIMIZATIONS=!1,this.TESTS_DISABLE_FAST_UPDATES=!1,this.DRAW_MESH_GEOMETRY_NORMALS=!1,this.FEATURE_TILE_FETCH_SHOW_TILES=!1,this.FEATURE_TILE_TREE_SHOW_TILES=!1,this.TERRAIN_TILE_TREE_SHOW_TILES=!1,this.I3S_TREE_SHOW_TILES=!1,this.I3S_SHOW_MODIFICATIONS=!1,this.LOD_INSTANCE_RENDERER_DISABLE_UPDATES=!1,this.LOD_INSTANCE_RENDERER_COLORIZE_BY_LEVEL=!1,this.EDGES_SHOW_HIDDEN_TRANSPARENT_EDGES=!1,this.LINE_WIREFRAMES=!1}};Y([te()],zr.prototype,"SCENEVIEW_HITTEST_RETURN_INTERSECTOR",void 0),Y([te()],zr.prototype,"DECONFLICTOR_SHOW_VISIBLE",void 0),Y([te()],zr.prototype,"DECONFLICTOR_SHOW_INVISIBLE",void 0),Y([te()],zr.prototype,"DECONFLICTOR_SHOW_GRID",void 0),Y([te()],zr.prototype,"LABELS_SHOW_BORDER",void 0),Y([te()],zr.prototype,"TEXT_SHOW_BASELINE",void 0),Y([te()],zr.prototype,"TEXT_SHOW_BORDER",void 0),Y([te()],zr.prototype,"OVERLAY_DRAW_DEBUG_TEXTURE",void 0),Y([te()],zr.prototype,"OVERLAY_SHOW_CENTER",void 0),Y([te()],zr.prototype,"SHOW_POI",void 0),Y([te()],zr.prototype,"TESTS_DISABLE_OPTIMIZATIONS",void 0),Y([te()],zr.prototype,"TESTS_DISABLE_FAST_UPDATES",void 0),Y([te()],zr.prototype,"DRAW_MESH_GEOMETRY_NORMALS",void 0),Y([te()],zr.prototype,"FEATURE_TILE_FETCH_SHOW_TILES",void 0),Y([te()],zr.prototype,"FEATURE_TILE_TREE_SHOW_TILES",void 0),Y([te()],zr.prototype,"TERRAIN_TILE_TREE_SHOW_TILES",void 0),Y([te()],zr.prototype,"I3S_TREE_SHOW_TILES",void 0),Y([te()],zr.prototype,"I3S_SHOW_MODIFICATIONS",void 0),Y([te()],zr.prototype,"LOD_INSTANCE_RENDERER_DISABLE_UPDATES",void 0),Y([te()],zr.prototype,"LOD_INSTANCE_RENDERER_COLORIZE_BY_LEVEL",void 0),Y([te()],zr.prototype,"EDGES_SHOW_HIDDEN_TRANSPARENT_EDGES",void 0),Y([te()],zr.prototype,"LINE_WIREFRAMES",void 0),zr=Y([oe("esri.views.3d.support.DebugFlags")],zr);new zr;var Vr,$r;!function(e){e[e.Undefined=0]="Undefined",e[e.DefinedSize=1]="DefinedSize",e[e.DefinedScale=2]="DefinedScale"}(Vr||(Vr={})),function(e){e[e.Undefined=0]="Undefined",e[e.DefinedAngle=1]="DefinedAngle"}($r||($r={}));const Hr=8;function Br(e,t){const{vertex:o,attributes:i}=e;t.hasVvInstancing&&(t.vvSize||t.vvColor)&&i.add(ut.INSTANCEFEATUREATTRIBUTE,"vec4"),t.vvSize?(o.uniforms.add(new vi("vvSizeMinSize",(e=>e.vvSize.minSize))),o.uniforms.add(new vi("vvSizeMaxSize",(e=>e.vvSize.maxSize))),o.uniforms.add(new vi("vvSizeOffset",(e=>e.vvSize.offset))),o.uniforms.add(new vi("vvSizeFactor",(e=>e.vvSize.factor))),o.uniforms.add(new gn("vvSymbolRotationMatrix",(e=>e.vvSymbolRotationMatrix))),o.uniforms.add(new vi("vvSymbolAnchor",(e=>e.vvSymbolAnchor))),o.code.add(Tt`vec3 vvScale(vec4 _featureAttribute) {
...
color.a = 1.0;
        ...
        `);break;case ti.Normal:{lr(n,t),e.include(Zn,t),e.include(oi,t),e.include(Cn,t),e.include(ai,t),e.include(Br,t),a&&r.uniforms.add(new mi("tex",(e=>e.texture))),t.normalType===ii.ScreenDerivative&&e.varyings.add("vPositionView","vec3");const o=t.normalType===ii.Attribute||t.normalType===ii.Compressed;n.code.add(Tt`
          void main(void) {
            vpos = calculateVPos();
            ${s?"vpos = (model * vec4(vpos, 1.0)).xyz;":""}
        ...
        `);break}case ti.Highlight:lr(n,t),e.include(Zn,t),e.include(ai,t),e.include(Br,t),a&&r.uniforms.add(new mi("tex",(e=>e.texture))),n.code.add(Tt`
          void main(void) {
            vpos = calculateVPos();
            ${s?"vpos = (model * vec4(vpos, 1.0)).xyz;":""}
            vpos = subtractOrigin(vpos);
...
}`)}function hs(e){const t=e.camera.projectionMatrix;return 0===t[11]?Z(ds,2/(e.camera.fullWidth*t[0]),2/(e.camera.fullHeight*t[5]),(1+t[12])/t[0],(1+t[13])/t[5]):Z(ds,-2/(e.camera.fullWidth*t[0]),-2/(e.camera.fullHeight*t[5]),(1-t[8])/t[0],(1-t[9])/t[5])}const ds=J();function vs(e){return 0===e.camera.projectionMatrix[11]?Bt(fs,0,1):Bt(fs,1,0)}const fs=Gt();const ms=16;function ps(){const e=new Zr,t=e.fragment;return e.include(qr),t.include(Xr),e.include(us),t.uniforms.add(new rr("radius",((e,t)=>gs(t.camera)))),t.code.add(Tt`vec3 sphere[16];
void fillSphere() {
...
}`)):1===i?(o.uniforms.add(new Cr("lightingAmbientSH_R",((e,t)=>Z(Ts,t.lighting.sh.r[0],t.lighting.sh.r[1],t.lighting.sh.r[2],t.lighting.sh.r[3]))),new Cr("lightingAmbientSH_G",((e,t)=>Z(Ts,t.lighting.sh.g[0],t.lighting.sh.g[1],t.lighting.sh.g[2],t.lighting.sh.g[3]))),new Cr("lightingAmbientSH_B",((e,t)=>Z(Ts,t.lighting.sh.b[0],t.lighting.sh.b[1],t.lighting.sh.b[2],t.lighting.sh.b[3])))),o.code.add(Tt`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):2===i&&(o.uniforms.add(new vi("lightingAmbientSH0",((e,t)=>g(ys,t.lighting.sh.r[0],t.lighting.sh.g[0],t.lighting.sh.b[0]))),new Cr("lightingAmbientSH_R1",((e,t)=>Z(Ts,t.lighting.sh.r[1],t.lighting.sh.r[2],t.lighting.sh.r[3],t.lighting.sh.r[4]))),new Cr("lightingAmbientSH_G1",((e,t)=>Z(Ts,t.lighting.sh.g[1],t.lighting.sh.g[2],t.lighting.sh.g[3],t.lighting.sh.g[4]))),new Cr("lightingAmbientSH_B1",((e,t)=>Z(Ts,t.lighting.sh.b[1],t.lighting.sh.b[2],t.lighting.sh.b[3],t.lighting.sh.b[4]))),new Cr("lightingAmbientSH_R2",((e,t)=>Z(Ts,t.lighting.sh.r[5],t.lighting.sh.r[6],t.lighting.sh.r[7],t.lighting.sh.r[8]))),new Cr("lightingAmbientSH_G2",((e,t)=>Z(Ts,t.lighting.sh.g[5],t.lighting.sh.g[6],t.lighting.sh.g[7],t.lighting.sh.g[8]))),new Cr("lightingAmbientSH_B2",((e,t)=>Z(Ts,t.lighting.sh.b[5],t.lighting.sh.b[6],t.lighting.sh.b[7],t.lighting.sh.b[8])))),o.code.add(Tt`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
return max(c.x, max(c.y, c.z));
  ...
  `)}function Xs(e){const t=new Zr,{vertex:n,fragment:r,varyings:s}=t;if(lr(n,e),t.include(fn),s.add("vpos","vec3"),t.include(Br,e),t.include(mr,e),t.include(_r,e),e.hasColorTextureTransform&&t.include(Bs),e.output===ti.Color||e.output===ti.Alpha){e.hasNormalTextureTransform&&t.include(Gs),e.hasEmissionTextureTransform&&t.include(Us),e.hasOcclusionTextureTransform&&t.include(js),e.hasMetallicRoughnessTextureTransform&&t.include(Ws),ar(n,e),t.include(oi,e),t.include(Zn,e);const r=e.normalType===ii.Attribute||e.normalType===ii.Compressed;r&&e.offsetBackfaces&&t.include(Hn),t.include(kr,e),t.include(Cn,e),e.instancedColor&&t.attributes.add(ut.INSTANCECOLOR,"vec4"),s.add("vPositionLocal","vec3"),t.include(ai,e),t.include($n,e),t.include(wr,e),t.include(br,e),n.uniforms.add(new Cr("externalColor",(e=>e.externalColor))),s.add("vcolorExt","vec4"),e.hasMultipassTerrain&&s.add("depth","float");const a=e.hasModelTransformation;if(a){const e=i();n.uniforms.add(new xn("model",(e=>e.modelTransformation??xe))),n.uniforms.add(new gn("normalTransform",(t=>(o(e,t.modelTransformation??xe),e))))}n.code.add(Tt`
      void main(void) {
    ...
    `)}return t.include(Wr,e),t}const Ks=Object.freeze(Object.defineProperty({__proto__:null,build:Xs},Symbol.toStringTag,{value:"Module"}));class Qs extends yn{constructor(){super(...arguments),this.isSchematic=!1,this.usePBR=!1,this.mrrFactors=re(Pn),this.hasVertexColors=!1,this.hasSymbolColors=!1,this.doubleSided=!1,this.doubleSidedType="normal",this.cullFace=tt.Back,this.isInstanced=!1,this.hasInstancedColor=!1,this.emissiveFactor=h(0,0,0),this.instancedDoublePrecision=!1,this.normalType=ii.Attribute,this.receiveSSAO=!0,this.receiveShadows=!0,this.castShadows=!0,this.shadowMappingEnabled=!1,this.ambient=h(.2,.2,.2),this.diffuse=h(.8,.8,.8),this.externalColor=ee(1,1,1,1),this.colorMixMode="multiply",this.opacity=1,this.layerOpacity=1,this.origin=c(),this.hasSlicePlane=!1,this.hasSliceHighlight=!0,this.offsetTransparentBackfaces=!1,this.vvSize=null,this.vvColor=null,this.vvOpacity=null,this.vvSymbolAnchor=null,this.vvSymbolRotationMatrix=null,this.modelTransformation=null,this.transparent=!1,this.writeDepth=!0,this.customDepthTest=ot.Less,this.textureAlphaMode=et.Blend,this.textureAlphaCutoff=Tn,this.textureAlphaPremultiplied=!1,this.hasOccludees=!1,this.renderOccluded=Xi.Occlude}}class Ys extends _n{initializeConfiguration(e,t){t.spherical=e.viewingMode===yt.Global,t.doublePrecisionRequiresObfuscation=e.rctx.driverTest.doublePrecisionRequiresObfuscation.result,t.textureCoordinateType=t.hasColorTexture||t.hasMetallicRoughnessTexture||t.hasEmissionTexture||t.hasOcclusionTexture||t.hasNormalTexture?si.Default:si.None,t.objectAndLayerIdColorInstanced=t.instanced}initializeProgram(e){return this._initializeProgram(e,Ys.shader)}_initializeProgram(e,t){return new Mn(e.rctx,t.get().build(this.configuration),Ci)}_convertDepthTestFunction(e){return e===ot.Lequal?pt.LEQUAL:pt.LESS}_makePipeline(e,t){const o=this.configuration,i=e===St.NONE,n=e===St.FrontFace;return Lt({blending:o.output!==ti.Color&&o.output!==ti.Alpha||!o.transparent?null:i?Ot:Rt(e),culling:Zs(o)?It(o.cullFace):null,depthTest:{func:Pt(e,this._convertDepthTestFunction(o.customDepthTest))},depthWrite:(i||n)&&o.writeDepth?Et:null,colorWrite:Nt,stencilWrite:o.hasOccludees?Ln:null,stencilTest:o.hasOccludees?t?Rn:On:null,polygonOffset:i||n?null:Ft(o.enableOffset)})}initializePipeline(){return this._occludeePipelineState=this._makePipeline(this.configuration.transparencyPassType,!0),this._makePipeline(this.configuration.transparencyPassType,!1)}getPipelineState(e,t){return t?this._occludeePipelineState:super.getPipelineState(e,t)}}function Zs(e){return e.cullFace!==tt.None||!e.hasSlicePlane&&(!e.transparent&&!e.doubleSidedMode)}Ys.shader=new Sn(Ks,(()=>import("./p-6596668e.js")));class Js extends dr{}Y([vr({constValue:!0})],Js.prototype,"hasSliceHighlight",void 0),Y([vr({constValue:!1})],Js.prototype,"hasSliceInVertexProgram",void 0),Y([vr({constValue:!1})],Js.prototype,"instancedDoublePrecision",void 0),Y([vr({constValue:!1})],Js.prototype,"hasModelTransformation",void 0),Y([vr({constValue:ui.Pass})],Js.prototype,"pbrTextureBindType",void 0);class ea extends Js{constructor(){super(...arguments),this.output=ti.Color,this.alphaDiscardMode=et.Opaque,this.doubleSidedMode=ri.None,this.pbrMode=wi.Disabled,this.cullFace=tt.None,this.transparencyPassType=St.NONE,this.normalType=ii.Attribute,this.textureCoordinateType=si.None,this.customDepthTest=ot.Less,this.spherical=!1,this.hasVertexColors=!1,this.hasSymbolColors=!1,this.hasVerticalOffset=!1,this.hasSlicePlane=!1,this.hasSliceHighlight=!0,this.hasColorTexture=!1,this.hasMetallicRoughnessTexture=!1,this.hasEmissionTexture=!1,this.hasOcclusionTexture=!1,this.hasNormalTexture=!1,this.hasScreenSizePerspective=!1,this.hasVertexTangents=!1,this.hasOccludees=!1,this.hasMultipassTerrain=!1,this.hasModelTransformation=!1,this.offsetBackfaces=!1,this.vvSize=!1,this.vvColor=!1,this.receiveShadows=!1,this.receiveAmbientOcclusion=!1,this.textureAlphaPremultiplied=!1,this.instanced=!1,this.instancedColor=!1,this.objectAndLayerIdColorInstanced=!1,this.instancedDoublePrecision=!1,this.doublePrecisionRequiresObfuscation=!1,this.writeDepth=!0,this.transparent=!1,this.enableOffset=!0,this.cullAboveGround=!1,this.snowCover=!1,this.hasColorTextureTransform=!1,this.hasEmissionTextureTransform=!1,this.hasNormalTextureTransform=!1,this.hasOcclusionTextureTransform=!1,this.hasMetallicRoughnessTextureTransform=!1}}Y([vr({count:ti.COUNT})],ea.prototype,"output",void 0),Y([vr({count:et.COUNT})],ea.prototype,"alphaDiscardMode",void 0),Y([vr({count:ri.COUNT})],ea.prototype,"doubleSidedMode",void 0),Y([vr({count:wi.COUNT})],ea.prototype,"pbrMode",void 0),Y([vr({count:tt.COUNT})],ea.prototype,"cullFace",void 0),Y([vr({count:St.COUNT})],ea.prototype,"transparencyPassType",void 0),Y([vr({count:ii.COUNT})],ea.prototype,"normalType",void 0),Y([vr({count:si.COUNT})],ea.prototype,"textureCoordinateType",void 0),Y([vr({count:ot.COUNT})],ea.prototype,"customDepthTest",void 0),Y([vr()],ea.prototype,"spherical",void 0),Y([vr()],ea.prototype,"hasVertexColors",void 0),Y([vr()],ea.prototype,"hasSymbolColors",void 0),Y([vr()],ea.prototype,"hasVerticalOffset",void 0),Y([vr()],ea.prototype,"hasSlicePlane",void 0),Y([vr()],ea.prototype,"hasSliceHighlight",void 0),Y([vr()],ea.prototype,"hasColorTexture",void 0),Y([vr()],ea.prototype,"hasMetallicRoughnessTexture",void 0),Y([vr()],ea.prototype,"hasEmissionTexture",void 0),Y([vr()],ea.prototype,"hasOcclusionTexture",void 0),Y([vr()],ea.prototype,"hasNormalTexture",void 0),Y([vr()],ea.prototype,"hasScreenSizePerspective",void 0),Y([vr()],ea.prototype,"hasVertexTangents",void 0),Y([vr()],ea.prototype,"hasOccludees",void 0),Y([vr()],ea.prototype,"hasMultipassTerrain",void 0),Y([vr()],ea.prototype,"hasModelTransformation",void 0),Y([vr()],ea.prototype,"offsetBackfaces",void 0),Y([vr()],ea.prototype,"vvSize",void 0),Y([vr()],ea.prototype,"vvColor",void 0),Y([vr()],ea.prototype,"receiveShadows",void 0),Y([vr()],ea.prototype,"receiveAmbientOcclusion",void 0),Y([vr()],ea.prototype,"textureAlphaPremultiplied",void 0),Y([vr()],ea.prototype,"instanced",void 0),Y([vr()],ea.prototype,"instancedColor",void 0),Y([vr()],ea.prototype,"objectAndLayerIdColorInstanced",void 0),Y([vr()],ea.prototype,"instancedDoublePrecision",void 0),Y([vr()],ea.prototype,"doublePrecisionRequiresObfuscation",void 0),Y([vr()],ea.prototype,"writeDepth",void 0),Y([vr()],ea.prototype,"transparent",void 0),Y([vr()],ea.prototype,"enableOffset",void 0),Y([vr()],ea.prototype,"cullAboveGround",void 0),Y([vr()],ea.prototype,"snowCover",void 0),Y([vr()],ea.prototype,"hasColorTextureTransform",void 0),Y([vr()],ea.prototype,"hasEmissionTextureTransform",void 0),Y([vr()],ea.prototype,"hasNormalTextureTransform",void 0),Y([vr()],ea.prototype,"hasOcclusionTextureTransform",void 0),Y([vr()],ea.prototype,"hasMetallicRoughnessTextureTransform",void 0),Y([vr({constValue:!0})],ea.prototype,"hasVvInstancing",void 0),Y([vr({constValue:!1})],ea.prototype,"useCustomDTRExponentForWater",void 0),Y([vr({constValue:!1})],ea.prototype,"supportsTextureAtlas",void 0),Y([vr({constValue:!0})],ea.prototype,"useFillLights",void 0);function ta(e){const t=new Zr,{vertex:o,fragment:i,varyings:n}=t;return lr(o,e),t.include(fn),n.add("vpos","vec3"),t.include(Br,e),t.include(mr,e),t.include(_r,e),e.output!==ti.Color&&e.output!==ti.Alpha||(ar(t.vertex,e),t.include(oi,e),t.include(Zn,e),e.offsetBackfaces&&t.include(Hn),e.instancedColor&&t.attributes.add(ut.INSTANCECOLOR,"vec4"),n.add("vNormalWorld","vec3"),n.add("localvpos","vec3"),e.hasMultipassTerrain&&n.add("depth","float"),t.include(ai,e),t.include($n,e),t.include(wr,e),t.include(br,e),o.uniforms.add(new Cr("externalColor",(e=>e.externalColor))),n.add("vcolorExt","vec4"),o.code.add(Tt`
        void main(void) {
          forwardNormalizedVertexColor();
          vcolorExt = externalColor;
          ${e.instancedColor?"vcolorExt *= instanceColor * 0.003921568627451;":""}
